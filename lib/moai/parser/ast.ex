defmodule Moai.Parser.Ast do
  ...
  @type annotation() ::
          {:type, Moai.Typing.Types.t() | Moai.Typing.Types.alias()} | {:errors, errors()}
  ...
  @spec update_meta(
          ...
          | op_node(),
          key :: :type | :errors,
          value :: Moai.Typing.Types.t() | Moai.Typing.Types.alias() | errors()
        ) ::
          id_node()
          | list_node()
          | list_comp_node()
